...
def evaluate(individual, sigma):
    ...
    # Fitness for returns
    returns_fitness = evaluate_return(expense_ratio, portfolio_turnover_ratio, sigma)
    ...
    portfolio_turnover_ratio = max(BOUND_LOW, min(BOUND_UP, portfolio_turnover_ratio))
...
toolbox.register("mutate", tools.mutPolynomialBounded, eta=20, low=0, up=1, indpb=0.2)
